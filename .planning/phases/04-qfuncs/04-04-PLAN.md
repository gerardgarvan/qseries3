...
must_haves:
  truths:
    ...
    - "aqprod, qbin, theta, tripleprod, quinprod, winquist tests pass"
    - "nthelpers (divisors, mobius, legendre, sigma, euler_phi) return correct values"
...
3. **legendre:** legendre(2,7)==1, legendre(3,7)==-1 (nthelpers spot-check)
</action>
